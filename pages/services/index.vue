  ...
  <div>
    <div v-if="servicesPage">
      <transition name="fade" appear>
        <div class="img-hero" :style="   { backgroundImage: 'url(' + servicesPage.featured_image + ')' }">
        </div>
      </transition>
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="container">
            ...
            <h2 v-html="servicesPage.acf.brandraising_benchmark_heading"></h2>
            <div v-for="service in services" v-if="service.slug === 'brandraising-benchmark'">
              <Service :entry="service"></Service>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
            <blockquote class="col-md-9">
              <p v-html="servicesPage.acf.quote"></p>
              <footer>-- <span v-html="servicesPage.acf.credit"></span></footer>
            </blockquote>
