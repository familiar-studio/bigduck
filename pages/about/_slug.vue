  ...
  <div class="team">
    ...
    <div class="container overlap" id="content">
      <article class="main" :class="{'mb-5': !relatedInsights && !relatedEvents }">
        ...
        <div class="row">
          <div class="col-md-9">
              <h4>
                {{member.job_title}}
                <a v-if="member.twitter_handle" :href="'http://twitter.com/' + member.twitter_handle" class="ml-3">
              ...
              <a v-if="member.facebook_page" :href="'http://facebook.com/' + member.facebook_page">
                <div class="badge badge-default social">
                  <span>
      ...
      <div class="" v-if="relatedInsights && relatedInsights.length > 0">
        <h2 :class="{'mt-5': !relatedEvents }">Insights by {{ member.name.split(" ")[0]}}</h2>
