...
class AOAPI_Legacy {
    ...
    /**
     * Connect to the MailChimp API for a given list. All AOAPI_Legacy calls require login before functioning
     *
     ...
     */
    function AOAPI_Legacy($username_or_apikey, $password=null, $secure=false) {
    ...
    */
     ...
     * @return boolean true on success, false on failure. When using AOAPI_Legacy.class.php, the value can be tested and error messages pulled from the AOAPI_Legacy object (see below)
     */
     ...
     * @return boolean true on success, false on failure. When using AOAPI_Legacy.class.php, the value can be tested and error messages pulled from the AOAPI_Legacy object
     */
    ...
    function callServer($method, $params) {
        ...
        $payload .= "User-Agent: AOAPI_Legacy/" . $this->version ."\r\n";
