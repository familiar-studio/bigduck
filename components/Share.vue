<template>
  <div class="share" id="share">
    ...
    <div>
      ...
      <a :href="'https://twitter.com/intent/tweet?text=' + path" target="_blank" class="fill-change">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
      ...
      <a :href="'http://www.linkedin.com/shareArticle?mini=true&url=' + path" class="fill-change">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
